            ...
            <div class="bg-white dark:bg-gray-800 relative overflow-x-auto overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    <div class="flex flex-col pb-3">
                        <img class="w-20 h-20 rounded-full mb-4" src="{{ $customer->avatar }}" alt="Image" />
                    ...
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Mobile Number</dt>
                        <dd class="text-lg font-semibold">{{ $customer->phone }}</dd>
                    </div>
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Company</dt>
                        <dd class="text-lg font-semibold">{{ $customer->organisation }}</dd>
                    </div>
